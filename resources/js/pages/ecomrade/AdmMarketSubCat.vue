      ...
      <div v-if="type == 'admin'" class="container">
        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Market Sub-cat</strong></li>
                </ol>
              </div>
            </nav>
          </div>
          ...
          <div style="float:right;" class="col-md-6 col-2">
            <router-link :to="{ name: 'CreateMarketSubCategory' }" style="float: right;">
            ...
            <div class="">
              <div class="table-responsive">
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(category, index) in getmarketsubcategories" :key="category.id">
                      ...
                      <td>
                        <span class="badge badge-soft-success mb-0">{{ category.name }}</span>
                      </td>
                      <td v-if="id == 1">
                        <router-link class="edit-link"
                          :to="{ name: 'PolishMarketSubCategory', params: { id: category.id } }">
                      ...
                      <td v-if="id == 1">
                        <button type="button" @click="destroy(category.id)" class="delete-btn"
                ...
                <h5 v-if="!getmarketsubcategories.length">Sorry, no item found!</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
            ...
            <g id="fortyfour" data-name="Layer 2">
              <g class="four a">
                ...
                <rect class="cls-3" x="197.13" y="122.89" width="120.71" height="604.75" rx="60.36" ry="60.36"
                  transform="translate(290.49 -70.78) rotate(35)" />

              </g>
              <g class="four b">

                <rect class="cls-2" x="1558.84" y="391.91" width="120.71" height="466.29" rx="57.1" ry="57.1"
                ...
                <rect class="cls-3" x="1522.22" y="123.66" width="120.71" height="604.75" rx="60.36" ry="60.36"
            ...
            <g id="umbrella" data-name="Layer 3">
              <g>
                ...
                <g>
                  ...
                  <rect class="cls-4" x="1028.09" y="399.36" width="21.46" height="32.27" rx="10.73" ry="10.73"
            ...
            <g id="box" data-name="Layer 9">
              <g id="box-top">
                <polygon class="cls-8" points="569.71 382.28 653.74 329.39 747.13 320.1 679.2 369.85 569.71 382.28">
                </polygon>
                <polygon class="cls-5" points="691.95 367.2 570.87 392.34 565.32 383.35 687.8 357.45 691.95 367.2">
                </polygon>
                ...
                <polygon class="cls-5" points="747.13 320.1 661.54 337.48 652.25 322.38 738.4 307.1 747.13 320.1">
                </polygon>
              </g>
              <path class="cls-5" d="M588.28,420.26s3.44,5.2,5.19,8l43.1,68.48,158.81-100-43.1-68.48q-2.63-4.17-5.47-8Z">
              </path>
              <path class="cls-7" d="M588.28,420.26s3.44,5.2,5.19,8l43.1,68.48,158.81-100-43.1-68.48q-2.63-4.17-5.47-8Z">
              </path>
...
export default {
  ...
  methods: {
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios
            ...
            .delete("/api/marketsubcategories/" + id)
            .then((response) => {
              this.success = true;
              Swal.fire(
                'Deleted!',
              ...
              axios.get('/api/getmarketsubcategories')
                .then(response => {
                  this.getmarketsubcategories = response.data.data;
                });
            }).catch((error) => {
    ...
    fetchSubCategories() {
      axios
        .get("/api/getmarketsubcategories")
        .then((response) => (this.getmarketsubcategories = response.data))
        .catch((error) => {
          console.log(error);
        });
    },
