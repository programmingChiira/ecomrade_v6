            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Feedback</strong></li>
                </ol>
              </div>
            </nav>
          </div>
          ...
          <div class="col-lg-12">
            <div class="">
              <div class="table-responsive">
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(feed, index) in feeds" :key="feed.id">
                      ...
                      <td>
                        <span class="badge badge-soft-success mb-0">{{ feed.name }}</span>
                      </td>
                      <td>
                        {{ feed.contact }}
                      </td>
                ...
                <h5 v-if="!feeds.length">Sorry, no item found!</h5>
              </div>
            </div>
          </div>
        </div>
