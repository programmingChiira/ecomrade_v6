            ...
            <div v-if="type == 'admin'" class="container">
                <div class="row">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                            <div class="container">
                                <ol class="breadcrumb">
                                    ...
                                    <li style="color: #189483;" class="breadcrumb-item"><strong>Market Reports</strong></li>
                                </ol>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div style="float:right;" class="col-md-8 col-2">
                        <router-link :to="{ name: 'CreateMarket' }" style="float: right;">
                                ...
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Market title</th>
                                            <th scope="col">Market slug</th>
                                            <th scope="col">Issue</th>
                                            <th scope="col">Complain</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="marketreport in marketreports" :key="marketreport.id">
                                            ...
                                            <td>
                                                <img v-if="marketreport.marketImg == false || marketreport.marketImg == null || marketreport.marketImg == 'null' || marketreport.marketImg == '' || marketreport.marketImg == ' ' || marketreport.marketImg == NULL"
                                                    loading="lazy" src="/web/img/no_img.jpg"
                                                    class="avatar-sm rounded-circle me-2">

                                                <img v-else :src="'./img/market/' + marketreport.marketImg"
                                                    class="avatar-sm rounded-circle me-2">
                                            </td>
                                            <td>{{ marketreport.senderName }}</td>
                                            <td>{{ marketreport.senderPhone }}</td>
                                            <td><span class="badge badge-soft-success mb-0">{{ marketreport.marketName
                                            }}</span></td>
                                            <td>
                                                <router-link :to="{
                                                        name: 'ViewMarket',
                                                        params: { slug: marketreport.marketSlug },
                                                    }">
                                            ...
                                            <td>{{ marketreport.marketIssue }}</td>
                                            <td>{{ marketreport.marketComplaint }}</td>
                                        </tr>
                                        <tr>
                                        </tr>
                                    </tbody>
                                </table>
                                <h5 v-if="!marketreports.length">Sorry, no item found!</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if (result.value) {
                    axios
                        ...
                        .then((response) => {
                            ...
                            axios.get('/api/marketreports')
                                .then(response => {
                                    this.marketreports = response.data.data;
                                });
                        }).catch((error) => {
