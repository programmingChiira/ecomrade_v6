            ...
            <div class="container">
                <div class="row">
                    ...
                    <div style="float: right" class="col-md-8 col-6">
                        <router-link style="margin: 10px;float:right;" title="Change password" :to="'/editPassword' + slug" class="btn bg-gradient-primary btn-sm">
                            <i style="font-size: 12px;color: white;" class="fa fa-eye-slash"></i>
                        </router-link>
                    </div>
                </div>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div v-if="step === 2">
                                ...
                                <label for="personal_description"
                                    ><span> Personal description</span></label
                                >
                                <textarea
                                    class="form-control"
                                    id="personal_description"
                                    v-model="fields.personal_description"
                                    rows="6"
                                ></textarea>
                                <span
                                    v-if="errors.personal_description"
                                    class="error"
                                    >{{ errors.personal_description[0] }}</span
                                >
                                <br />
                                ...
                                <input
                                    ...
                                    type="text"
                                    id="campus"
                                    v-model="fields.campus"
                                />
                                <span v-if="errors.campus" class="error">{{
                                    errors.campus[0]
                                }}</span>
                                <br />

                                <label for="campus_area"
                                    ><span>Campus Area</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                    id="campus_area"
                                    v-model="fields.campus_area"
                                />
                                <span v-if="errors.campus_area" class="error">{{
                                    errors.campus[0]
                                }}</span>
                                <br />
                            ...
                            <div v-if="step === 3">
                                <h4>My links</h4>
                                <label for="youtube"
                                    ><span>youtube Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span v-if="errors.youtube" class="error">{{
                                    errors.youtube[0]
                                }}</span>
                                <br />

                                <label for="instagram"
                                    ><span>instagram Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span v-if="errors.instagram" class="error">{{
                                    errors.instagram[0]
                                }}</span>
                                <br />

                                <label for="twitter"
                                    ><span>twitter Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span v-if="errors.twitter" class="error">{{
                                    errors.twitter[0]
                                }}</span>
                                <br />

                                <label for="facebook"
                                    ><span>facebook Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span v-if="errors.facebook" class="error">{{
                                    errors.facebook[0]
                                }}</span>
                                <br />

                                <label for="linkedin"
                                    ><span>linkedin Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span v-if="errors.linkedin" class="error">{{
                                    errors.linkedin[0]
                                }}</span>
                                <br />

                                <label for="github"
                                    ><span>github Account Link</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                    id="github"
                                    v-model="fields.github"
                                />
                                <span v-if="errors.github" class="error">{{
                                    errors.github[0]
                                }}</span>
                                <br />
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    fd.append(
                        ...
                        this.fields.personal_description
                    );
