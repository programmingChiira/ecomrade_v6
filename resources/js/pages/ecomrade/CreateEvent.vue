                    ...
                    <div style="padding: 10px" class="col-lg-12 col-sm-12">
                        <form @submit.prevent="submit">
                            <div v-if="step === 1">
                                ...
                                <label for="title"
                                    ><span
                                        >Event Name<span style="color: red">
                                            *
                                        </span></span
                                    ></label
                                >
                                ...
                                <span v-if="errors.mode" class="error">{{
                                    errors.mode[0]
                                }}</span>
                                <br />
                                ...
                                <div v-if="eventEntry == 'Pay'">
                                    <label for="title"
                                        ><span>Entry Fee ( Ksh) </span></label
                                    >
                                    <input
                                        class="form-control"
                                        type="number"
                                        id="title"
                                        v-model="eventEntryFee"
                                    />
                                    <span v-if="errors.title" class="error">{{
                                        errors.title[0]
                                    }}</span>
                                ...
                                <label for="title"
                                    ><span>Pinned Location</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                            ...
                            <div v-if="step === 3">
                                ...
                                <label for="product_more_info"
                                    ><span> Event Description</span></label
                                >
                                <textarea
                                    class="form-control"
                                    type="text"
                                ...
                                <label for="requirement_1"
                                    ><span
                                        >Event requirement 1<span
                                            style="color: red"
                                        >
                                            *
                                        </span></span
                                ...
                                />
                                <span
                                    v-if="errors.requirement_1"
                                    class="error"
                                    >{{ errors.requirement_1[0] }}</span
                                >
                                <br />

                                <label for="requirement_2"
                                    ><span
                                        >Event requirement 2<span
                                            style="color: red"
                                        >
                                            *
                                        </span></span
                                ...
                                />
                                <span
                                    v-if="errors.requirement_2"
                                    class="error"
                                    >{{ errors.requirement_2[0] }}</span
                                >
                                <br />

                                <label for="requirement_3"
                                    ><span
                                        >Event requirement 3<span
                                            style="color: red"
                                        >
                                            *
                                        </span></span
                                ...
                                />
                                <span
                                    v-if="errors.requirement_3"
                                    class="error"
                                    >{{ errors.requirement_3[0] }}</span
                                >
                                <br />

                                <label for="requirement_4"
                                    ><span>Event requirement 4</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span
                                    v-if="errors.requirement_4"
                                    class="error"
                                    >{{ errors.requirement_4[0] }}</span
                                >
                                <br />

                                <label for="requirement_5"
                                    ><span>Event requirement 5</span></label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                ...
                                />
                                <span
                                    v-if="errors.requirement_5"
                                    class="error"
                                    >{{ errors.requirement_5[0] }}</span
                                >
                                <br />
                            ...
                            <div v-if="step === 4">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <span v-if="errors.time" class="error">{{
                                    errors.time[0]
                                }}</span>
                                <br />

                                <label for="mode"
                                    ><span>Show Contact</span></label
                                >
                                <select
                                    class="form-control"
                                    type="text"
                                    id="mode"
                                    v-model="eventShowContact"
                                >
                                    <option>Yes</option>
                                    <option>No</option>
                                </select>
