            ...
            <div v-if="type == 'admin'" class="container">
                <div class="row">
                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                            <div class="container">
                                <ol class="breadcrumb">
                                    ...
                                    <li style="color: #189483;" class="breadcrumb-item"><strong>Rental Reports</strong></li>
                                </ol>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div style="float:right;" class="col-md-8 col-2">
                        <router-link :to="{ name: 'CreateRental' }" style="float: right;">
                                ...
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Rental title</th>
                                            <th scope="col">Rental slug</th>
                                            <th scope="col">Issue</th>
                                            <th scope="col">Complain</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="rentalreport in rentalreports" :key="rentalreport.id">
                                            ...
                                            <td>
                                                <img v-if="rentalreport.rentalImg == false || rentalreport.rentalImg == null || rentalreport.rentalImg == 'null' || rentalreport.rentalImg == '' || rentalreport.rentalImg == ' ' || rentalreport.rentalImg == NULL"
                                                    loading="lazy" src="/web/img/no_img.jpg"
                                                    class="avatar-sm rounded-circle me-2">

                                                <img v-else :src="'./img/house/' + rentalreport.rentalImg"
                                                    class="avatar-sm rounded-circle me-2">
                                            </td>
                                            <td>{{ rentalreport.senderName }}</td>
                                            <td>{{ rentalreport.senderPhone }}</td>
                                            <td><span class="badge badge-soft-success mb-0">{{ rentalreport.rentalName
                                            }}</span></td>
                                            <td>
                                                <router-link :to="{
                                                        name: 'ViewRental',
                                                        params: { slug: rentalreport.rentalSlug },
                                                    }">
                                            ...
                                            <td>{{ rentalreport.rentalIssue }}</td>
                                            <td>{{ rentalreport.rentalComplaint }}</td>
                                        </tr>
                                        <tr>
                                        </tr>
                                    </tbody>
                                </table>
                                <h5 v-if="!rentalreports.length">Sorry, no item found!</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if (result.value) {
                    axios
                        ...
                        .then((response) => {
                            ...
                            axios.get('/api/rentalreports')
                                .then(response => {
                                    this.rentalreports = response.data.data;
                                });
                        }).catch((error) => {
