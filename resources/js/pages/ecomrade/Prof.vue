                ...
                <div class="layout">
                    <div class="row">
                        <div class="col-md-4 col-12" v-for="connection in connections" :key="connection.id">
                                        ...
                                        <div class="profile__value">
                                            <div class="profile__key">
                                                <router-link class="btn bg-gradient-primary btn-sm"
                                                    :to="{ name: 'User', params: { slug: connection.receiver_slug } }">
                                                    View profile
                                                </router-link>
                                            </div>
                                        </div>
                            ...
                            <div class="profile" v-show="connection.receiver_id == user.id && connection.status == 'Connected'">
                                <div class="profile__picture"><img src="/avatar.webp" alt="comrade" /></div>
                                <div class="profile__header">
                                    <div class="profile__account">
                                ...
                                <div class="profile__stats">
                                    <div class="profile__stat">
                                        <div class="profile__value">
                                            <div class="profile__key">
                                                <router-link class="btn bg-gradient-primary btn-sm"
                                                    :to="{ name: 'User', params: { slug: connection.sender_slug } }">
                                                    View profile
                                                </router-link>
                                            </div>
                                        </div>
