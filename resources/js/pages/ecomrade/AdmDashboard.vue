                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="h3 font-bold mb-0">{{ markets.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admmarket">
                                                        <div
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Rentals</span>
                                                    <span class="h3 font-bold mb-0">{{ rentals.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admrental">
                                                        <div
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Blogs</span>
                                                    <span class="h3 font-bold mb-0">{{ posts.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admblog">
                                                        <div
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Polls</span>
                                                    <span class="h3 font-bold mb-0">{{ polls.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admpoll">
                                                        <div
                                                            class="icon icon-shape bg-primary text-white text-lg rounded-circle">
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Events</span>
                                                    <span class="h3 font-bold mb-0">{{ events.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Clubs</span>
                                                    <span class="h3 font-bold mb-0">{{ clubs.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admclub">
                                                        <div
                                                            class="icon icon-shape bg-warning text-white text-lg rounded-circle">
                                    ...
                                    <div class="card shadow border-0">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <span
                                                        class="h6 font-semibold text-muted text-sm d-block mb-2">Resources</span>
                                                    <span class="h3 font-bold mb-0">{{ resources.length }}</span>
                                                </div>
                                                <div style="text-align: center;" class="col-auto">
                                                    <router-link class="text-info" to="/admresource">
                                                        <div
                ...
                <div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
                        ...
                        <g id="fortyfour" data-name="Layer 2">
                            <g class="four a">
                                ...
                                <rect class="cls-2" x="233.74" y="391.14" width="120.71" height="466.29" rx="57.1" ry="57.1"
                            ...
                            <g class="four b">
                                ...
                                <rect class="cls-2" x="1558.84" y="391.91" width="120.71" height="466.29" rx="57.1"
                                    ry="57.1" transform="translate(2244.26 -994.14) rotate(90)" />


                                <rect class="cls-3" x="1658.92" y="475.87" width="120.71" height="396.88" rx="60.36"
                                    ry="60.36" />

                                <rect class="cls-3" x="1522.22" y="123.66" width="120.71" height="604.75" rx="60.36"
                        ...
                        <g id="umbrella" data-name="Layer 3">
                            <g>
                                <circle class="cls-4" cx="1187.53" cy="240.3" r="7.66"
                                ...
                                <g>
                                    <rect class="cls-4" x="997.45" y="358.35" width="175.58" height="5.1"
                                        transform="translate(108.21 955.38) rotate(-49.71)" />
                                    <rect class="cls-4" x="1028.09" y="399.36" width="21.46" height="32.27" rx="10.73"
                        ...
                        <g id="clock" data-name="Layer 8">
                            ...
                            <circle class="cls-1" cx="847.7" cy="247.59" r="63.44"
                                transform="translate(-32.91 314.05) rotate(-20.6)" />
                            <rect class="cls-3 clock-hand-1" x="845" y="189.5" width="6.04" height="58" rx="3.02"
                                ry="3.02" />
                            ...
                            <circle class="cls-3" cx="847.7" cy="247.59" transform="translate(-32.91 314.05) rotate(-20.6)"
                                r="3" />
                        </g>
                    ...
                    <router-link to="/" class="btn bg-gradient-primary btn-sm">Go to Home</router-link>
                </div>
            </div>
        </section>
...
export default {
    ...
    mounted() {
        ...
        axios.get('/api/countUsers').then(response => {
