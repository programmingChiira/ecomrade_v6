                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    ...
                                    <tbody>
                                        <tr v-for="eventbooking in eventbookings" :key="eventbooking.id">
                                            ...
                                            <td>
                                                <img v-if="eventbooking.eventImg == false || eventbooking.eventImg == null || eventbooking.eventImg == 'null' || eventbooking.eventImg == '' || eventbooking.eventImg == ' ' || eventbooking.eventImg == NULL"
                                ...
                                <h5 v-if="!eventbookings.length">Sorry, no item found!</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if (result.value) {
                    axios
                        ...
                        .then((response) => {
                            ...
                            axios.get('/api/eventbookings')
                                .then(response => {
                                    this.eventbookings = response.data.data;
                                });
                        }).catch((error) => {
