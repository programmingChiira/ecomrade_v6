                      ...
                      <ul>
                        <li style="display: inline;" v-for="location in locations" :key="location.id">
                          <input data-bs-dismiss="modal" class="btn btn-sm" type="button" name="search"
                            :value="location.name" @click="title = location.name">
                        </li>
                    ...
                    <tr v-for="event in events" :key="event.id">
                      <th scope="row" class="ps-4">
                        <div class="form-check font-size-16"><input type="checkbox" class="form-check-input"
                            id="contacusercheck1" /><label class="form-check-label" for="contacusercheck1"></label></div>
                      </th>
                      <td>
                        <img
                          v-if="event.image_1 == false || event.image_1 == null || event.image_1 == 'null' || event.image_1 == '' || event.image_1 == ' ' || event.image_1 == NULL"
                          loading="lazy" src="/web/img/no_img.jpg" class="avatar-sm rounded-circle me-2">

                        <img v-else :src="'./img/event/' + event.image_1" class="avatar-sm rounded-circle me-2">
                      </td>
                      ...
                      <td>
                        ...
                        <span style="color: orange;font-size:15px;" v-if="event.diffInDays == 0">
                          Today</span>
                        <span style="color: #189483;font-size:15px;" v-else-if="event.diffInDays == 1"> Tomorrow</span>
                      ...
                      <td v-if="id == 1">
                        <button v-if="event.user_id == id" type="button" @click="destroy(event.id)" class="delete-btn"
