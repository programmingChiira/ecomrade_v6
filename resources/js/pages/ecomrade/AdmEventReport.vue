            ...
            <div v-if="type == 'admin'" class="container">
                <div class="row">
                    ...
                    <div style="float:right;" class="col-md-8 col-2">
                        <router-link :to="{ name: 'CreateEvent' }" style="float: right;">
                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    ...
                                    <tbody>
                                        <tr v-for="eventreport in eventreports" :key="eventreport.id">
                                            ...
                                            <td>
                                                <img v-if="eventreport.eventImg == false || eventreport.eventImg == null || eventreport.eventImg == 'null' || eventreport.eventImg == '' || eventreport.eventImg == ' ' || eventreport.eventImg == NULL"
                                                    loading="lazy" src="/web/img/no_img.jpg"
                                                    class="avatar-sm rounded-circle me-2">

                                                <img v-else :src="'./img/event/' + eventreport.eventImg"
                                                    class="avatar-sm rounded-circle me-2">
                                            </td>
                                            <td>{{ eventreport.senderName }}</td>
                                            <td>{{ eventreport.senderPhone }}</td>
                                            <td><span class="badge badge-soft-success mb-0">{{ eventreport.eventTitle
                                            }}</span></td>
                                            <td>
                                                <router-link :to="{
                                                        name: 'ViewEvent',
                                                        params: { slug: eventreport.eventSlug },
                                                    }">
                                            ...
                                            <td>{{ eventreport.eventIssue }}</td>
                                            <td>{{ eventreport.eventComplaint }}</td>
                                        </tr>
                                        <tr>
                                        </tr>
                                    </tbody>
                                </table>
                                <h5 v-if="!eventreports.length">Sorry, no item found!</h5>
                            </div>
                        </div>
                    </div>
                </div>
