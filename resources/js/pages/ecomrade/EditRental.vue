                    ...
                    <div style="padding: 10px;" class="col-lg-12 col-sm-12">
                        ...
                        <form @submit.prevent="submit">
                            <div v-if="step === 1">
                                ...
                                <label for="no_of_rooms"><span>No. of rooms available<span style="color: red;"> *
                                        </span></span></label>
                            ...
                            <div v-if="step === 3">
                                ...
                                <label for="rental_description_5"><span>Rental Description 5</span></label>
...
export default {
    ...
    watch: {
        selectedCategory: function (arg) {
            axios.get('/api/rentalcategories?name=' + this.selectedCategory)
                .then(response => {
    ...
    mounted() {
        ...
        axios
            .get("/api/rentals/" + this.slug)
            .then((response) => {
                this.fields = response.data.data;
                this.url1 = "./img/house/" + response.data.data.image_1;
                this.url2 = "./img/house/" + response.data.data.image_2;
                this.url3 = "./img/house/" + response.data.data.image_3;
                this.url4 = "./img/house/" + response.data.data.image_4;
                this.url5 = "./img/house/" + response.data.data.image_5;
                this.url6 = "./img/house/" + response.data.data.image_6;
                this.url7 = "./img/house/" + response.data.data.image_7;
