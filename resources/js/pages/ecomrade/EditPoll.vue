...
export default {
        ...
        submit() {
            ...
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    fd.append("show_owner", this.fields.show_owner);
    ...
    mounted() {
        ...
        axios
            .get("/api/polls/" + this.slug)
            .then((response) => {
                this.fields = response.data.data;
                this.url1 = "./img/poll/" + response.data.data.image_1;
                this.url2 = "./img/poll/" + response.data.data.image_2;
                this.url3 = "./img/poll/" + response.data.data.image_3;
                this.url4 = "./img/poll/" + response.data.data.image_4;
                this.url5 = "./img/poll/" + response.data.data.image_5;
                this.url6 = "./img/poll/" + response.data.data.image_6;
                this.url7 = "./img/poll/" + response.data.data.image_7;
