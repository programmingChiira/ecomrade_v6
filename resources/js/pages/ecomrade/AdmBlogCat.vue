      ...
      <div v-if="type == 'admin'" class="container">
        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Blog Cat</strong></li>
                </ol>
              </div>
            </nav>
          </div>
          ...
          <div style="float:right;" class="col-md-8 col-2">
            <router-link :to="{ name: 'CreateBlogCategory' }" style="float: right;">
                ...
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(category, index) in categories" :key="category.id">
                      ...
                      <td v-if="id == 1">
                        <router-link class="edit-link" :to="{ name: 'PolishBlogCategory', params: { id: category.id } }">
