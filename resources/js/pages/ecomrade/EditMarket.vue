                ...
                <div class="row align-items-center justify-content-center">
                    <div style="padding: 10px" class="col-lg-12 col-sm-12">
                        <form @submit.prevent="submit">
                            <div v-if="step === 1">
                                <h4>Product Info</h4>
                                <label for="product_name"><span>Product Name
                                ...
                                <button style="margin: 5px" class="btn btn-sm" @click.prevent="nextStep">
                                    Next
                                </button>
                            ...
                            <div v-if="step === 2">
                                ...
                                <input v-if="input10 === 10" class="form-control" type="file" id="image"
                                    @input="grabFile10" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input11 === 11" class="form-control" type="file" id="image"
                                    @input="grabFile11" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input12 === 12" class="form-control" type="file" id="image"
                                    @input="grabFile12" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input13 === 13" class="form-control" type="file" id="image"
                                    @input="grabFile13" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input14 === 14" class="form-control" type="file" id="image"
                                    @input="grabFile14" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input15 === 15" class="form-control" type="file" id="image"
                                    @input="grabFile15" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input16 === 16" class="form-control" type="file" id="image"
                                    @input="grabFile16" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input17 === 17" class="form-control" type="file" id="image"
                                    @input="grabFile17" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input18 === 18" class="form-control" type="file" id="image"
                                    @input="grabFile18" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input19 === 19" class="form-control" type="file" id="image"
                                    @input="grabFile19" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input20 === 20" class="form-control" type="file" id="image"
                                    @input="grabFile20" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input21 === 21" class="form-control" type="file" id="image"
                                    @input="grabFile21" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input22 === 22" class="form-control" type="file" id="image"
                                    @input="grabFile22" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input23 === 23" class="form-control" type="file" id="image"
                                    @input="grabFile23" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input24 === 24" class="form-control" type="file" id="image"
                                    @input="grabFile24" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <input v-if="input25 === 25" class="form-control" type="file" id="image"
                                    @input="grabFile25" />
                                <span v-if="errors.file" class="error">{{
                                    errors.file[0]
                                }}</span>
                                ...
                                <br />
                                <button style="margin: 5px" class="btn btn-sm" @click.prevent="prevStep">
                                    Prev
                                </button>
                                <button style="margin: 5px" class="btn btn-sm" @click.prevent="nextStep">
                                    Next
                            ...
                            <div v-if="step === 4">
                                ...
                                <br />
                                <label for="contact"><span>Seller Contact<span style="color: red">
                                            *
                                        </span></span></label>
    ...
    mounted() {
        ...
        axios
            ...
            .then((response) => {
                ...
                this.url8 = "./img/market/" + response.data.data.image_8;
                this.url9 = "./img/market/" + response.data.data.image_9;
                this.url10 = "./img/market/" + response.data.data.image_10;
                this.url11 = "./img/market/" + response.data.data.image_11;
                this.url12 = "./img/market/" + response.data.data.image_12;
                this.url13 = "./img/market/" + response.data.data.image_13;
                this.url14 = "./img/market/" + response.data.data.image_14;
                this.url15 = "./img/market/" + response.data.data.image_15;
                this.url16 = "./img/market/" + response.data.data.image_16;
                this.url17 = "./img/market/" + response.data.data.image_17;
                this.url18 = "./img/market/" + response.data.data.image_18;
                this.url19 = "./img/market/" + response.data.data.image_19;
                this.url20 = "./img/market/" + response.data.data.image_20;
                this.url21 = "./img/market/" + response.data.data.image_21;
                this.url22 = "./img/market/" + response.data.data.image_22;
                this.url23 = "./img/market/" + response.data.data.image_23;
                this.url24 = "./img/market/" + response.data.data.image_24;
                this.url25 = "./img/market/" + response.data.data.image_25;
            })
            .catch((error) => {
                if (error.response.status === 403) {
                    this.$router.push({ name: "Market" });
