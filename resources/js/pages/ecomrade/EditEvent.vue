                    ...
                    <div style="padding: 10px;" class="col-lg-12 col-sm-12">
                        <form @submit.prevent="submit">
                            <div v-if="step === 1">
                                ...
                                <label for="title"><span>Event Name</span></label>
                                <input class="form-control" type="text" id="title" v-model="eventTitle" />
                            ...
                            <div v-if="step === 3">
                                ...
                                <label for="requirement_1"><span>Event requirement 1</span></label>
                                <input class="form-control" type="text" id="requirement_1" v-model="eventReq1" />
                                <span v-if="errors.requirement_1" class="error">{{ errors.requirement_1[0] }}</span>
                                <br />

                                <label for="requirement_2"><span>Event requirement 2</span></label>
                                <input class="form-control" type="text" id="requirement_2" v-model="eventReq2" />
                                <span v-if="errors.requirement_2" class="error">{{ errors.requirement_2[0] }}</span>
                                <br />

                                <label for="requirement_3"><span>Event requirement 3</span></label>
                                <input class="form-control" type="text" id="requirement_3" v-model="eventReq3" />
                            ...
                            <div v-if="step === 4">
                                ...
                                <br />
                                <label for="time"><span>Seller Contact(Type)</span></label>
                                <input class="form-control" type="text" id="time" v-model="eventContact" />
...
export default {
    ...
    mounted() {
        ...
        axios
            .get("/api/events/" + this.slug)
            .then((response) => {
                this.fields = response.data.data;
                this.url1 = "./img/event/" + response.data.data.image_1;
                this.url2 = "./img/event/" + response.data.data.image_2;
                this.url3 = "./img/event/" + response.data.data.image_3;
                this.url4 = "./img/event/" + response.data.data.image_4;
                this.url5 = "./img/event/" + response.data.data.image_5;
