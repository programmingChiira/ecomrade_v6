      ...
      <div v-if="type == 'admin'" class="container">
        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Market Cat</strong></li>
                </ol>
              </div>
            </nav>
          </div>
          ...
          <div style="float:right;" class="col-md-6 col-4">
            <router-link :to="{ name: 'CreateMarketCategory' }" style="float: right;">
            ...
            <div class="">
              <div class="table-responsive">
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(category, index) in marketcategories" :key="category.id">
                      ...
                      <td v-if="id == 1">
                        <router-link class="edit-link"
                          :to="{ name: 'PolishMarketCategory', params: { id: category.id } }">
                ...
                <h5 v-if="!marketcategories.length">Sorry, no item found!</h5>
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    destroy(id) {
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete("/api/marketcategories/" + id)
            .then((response) => {
              this.success = true;
              Swal.fire(
                'Deleted!',
