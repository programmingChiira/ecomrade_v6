    ...
    <body class="about-us">
        ...
        <div class="container">
            <div class="main-body">
                ...
                <!-- Breadcrumb -->
                <h4 style="text-align: center;">{{ user.name }}'s products</h4>
                <br /><br />
                <!-- /Breadcrumb -->

                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6 col-12" v-for="market in markets" :key="market.id"
                        v-show="user.id == market.user_id">
                                ...
                                <div class="card-body pt-0 px-0">
                                    ...
                                    <div class="mx-3 mt-3 mb-2">
                                        <form @submit.prevent="submit(market)">
                                            ...
                                            <router-link v-if="id == false" data-toggle="tooltip" data-placement="bottom"
                                                title="Add to compare" style="font-size: 13px;" to="/login"
...
export default {
    ...
    mounted() {
        ...
        axios
            .get("/api/markets")
            .then((response) => (this.markets = response.data.data))
            .catch((error) => {
                console.log(error);
            });
