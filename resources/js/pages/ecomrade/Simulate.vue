                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                            <div class="container">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><router-link to="/resource">Simulate</router-link></li>
                                    <li style="color: #189483;" class="breadcrumb-item"><strong>Transaction</strong></li>
                                </ol>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row align-items-center  justify-content-center">
                    ...
                    <div style="padding: 10px;" class="col-lg-12 col-sm-12">
                        <form @submit.prevent="submit">
                            ...
                            <input class="form-control" type="text" id="amount" v-model="amountValue" />
                            ...
                            <input class="form-control" type="text" id="account" v-model="accountValue" />
                            <span v-if="errors.account" class="error">{{ errors.account[0] }}</span>
                            <input type="hidden" class="form-control form-control-lg" placeholder="Enter your slug"
                                aria-label="Slug" aria-describedby="name-addon" id="slug" v-model="slugValue" />
                            <span v-if="errors.slug" class="error">{{ errors.slug[0] }}</span>
                            <br />
...
export default {
    ...
    methods: {
        submit() {
            ...
            axios
                .post("/api/transact/create", this.field)
                .then(() => {
                    this.field = {};
                    this.errors = {};
                    this.success = true;
