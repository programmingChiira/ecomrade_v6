                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table class="table project-list-table table-nowrap align-middle table-borderless">
                                    ...
                                    <tbody>
                                        <tr v-for="rentalbooking in rentalbookings" :key="rentalbooking.id">
                                            ...
                                            <td>
                                                <img v-if="rentalbooking.rentalImg == false || rentalbooking.rentalImg == null || rentalbooking.rentalImg == 'null' || rentalbooking.rentalImg == '' || rentalbooking.rentalImg == ' ' || rentalbooking.rentalImg == NULL"
                                ...
                                <h5 v-if="!rentalbookings.length">Sorry, no item found!</h5>
                            </div>
                        </div>
                    </div>
                </div>
