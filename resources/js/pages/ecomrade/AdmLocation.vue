            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Locations</strong></li>
                </ol>
              </div>
            </nav>
          </div>
                ...
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(location, index) in locations" :key="location.id">
                      ...
                      <td>
                        <span class="badge badge-soft-success mb-0">{{ location.name }}</span>
                      </td>
                      <td v-if="id == 1">
                        <router-link class="edit-link" :to="{ name: 'PolishLocation', params: { id: location.id } }">
                      ...
                      <td v-if="id == 1">
                        <button type="button" @click="destroy(location.id)" class="delete-btn"
