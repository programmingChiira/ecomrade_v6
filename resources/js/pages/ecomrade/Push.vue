          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-7 d-flex justify-content-center flex-column">
                <div class="card d-flex blur justify-content-center p-4 shadow-lg my-sm-0 my-sm-6 mt-8 mb-2">
                  <div class="text-center">
                    <h3 class="text-gradient text-primary">Send notifications</h3>
                  </div>
                  <form id="contact-form" @submit.prevent="submit">
                    <div class="card-body pb-2">
                      <div class="form-group"> <textarea name="message" class="form-control" id="message" rows="6"
                          v-model="fields.message" required></textarea>
                      </div>
                      <div class="row">
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      fd.append("message", this.fields.message);
      ...
      axios
        ...
        .then(() => {
          ...
          // Dispatch the NewContactMessage event
          Echo.channel('contact-form').dispatch('NewContactMessage', {
