      ...
      <div v-if="type == 'admin'" class="container">
        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
              <div class="container">
                <ol class="breadcrumb">
                  ...
                  <li style="color: #189483;" class="breadcrumb-item"><strong>Years</strong></li>
                </ol>
              </div>
            </nav>
          </div>
          ...
          <div style="float:right;" class="col-md-6 col-2">
            <router-link :to="{ name: 'CreateYear' }" style="float: right;">
                ...
                <table class="table project-list-table table-nowrap align-middle table-borderless">
                  ...
                  <tbody>
                    <tr v-for="(year, index) in years" :key="year.id">
                      ...
                      <td>
                        <span class="badge badge-soft-success mb-0">{{ year.year }}</span>
                      </td>
                      <td v-if="id == 1">
                        <router-link class="edit-link" :to="{ name: 'PolishYear', params: { id: year.id } }">
                      ...
                      <td v-if="id == 1">
                        <button type="button" @click="destroy(year.id)" class="delete-btn"
