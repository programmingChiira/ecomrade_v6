              ...
              <div class="card card-bordered">
                <div style="background-color: #E9ECEF;border-radius: 5px;" class="card-header">
                  <router-link :to="{
                    ...
                    <img
                      v-if="user.profile_pic == false || user.profile_pic == null || user.profile_pic == 'null' || user.profile_pic == '' || user.profile_pic == ' ' || user.profile_pic == NULL"
                      loading="lazy"
                      style="width: 50px; height: 50px; border-radius: 75px; border: 1px solid black;object-fit: cover;"
                      src="/web/img/no_img.jpg">


                    <img loading="lazy" v-else :src="'./img/profiles/' + user.profile_pic"
                      style="width: 50px; height: 50px; border-radius: 75px; border: 1px solid black;object-fit: cover;">
                ...
                <div class="ps-container ps-theme-default ps-active-y" id="chat-content" ref="chatContent"
                  ...
                  <div v-for="(chat, index) in userchats" :key="index">
                    <div style="display: flex; flex-direction: column;">
                      <div v-if="chat.user_id != id && user.id == chat.user_id"
                        ...
                        <div class="media media-chat">
                          <div class="media-body">
                            ...
                            <a v-else href="#" title="File" data-toggle="tooltip" data-placement="bottom"
                              ...
                              <img loading="lazy"
                                ...
                                :src="'./img/userchatroom/' + chat.image_1">
                            </a>
                      ...
                      <div v-else-if="user.id == chat.receiver_id" style="align-self: flex-end;max-width:70%;">
                        <div class="media media-chat">
                          <div class="media-body">
                            <span
                              v-if="chat.image_1 == false || chat.image_1 == null || chat.image_1 == 'null' || chat.image_1 == '' || chat.image_1 == ' ' || chat.image_1 == NULL || chat.image_1 == 'undefined'">
                            </span>
                            <a v-else href="#" data-toggle="tooltip" data-placement="bottom" title="File"
                ...
                <form @submit.prevent="submit">
                  ...
                  <div class="publisher bt-1 border-light">
                    ...
                    <input type="hidden" v-model="receiverId1">
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      axios.post('/api/userchats', formData, {
