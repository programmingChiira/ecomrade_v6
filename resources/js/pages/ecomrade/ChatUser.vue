            ...
            <div class="col-md-12">
              <div class="card card-bordered">
                ...
                >
                  ...
                  >
                    ...
                    <img
                      loading="lazy"
                      v-else
                      :src="'./img/profiles/' + user.profile_pic"
                      style="
                        width: 50px;
                        height: 50px;
                        border-radius: 75px;
                ...
                >
                  <div v-for="(chat, index) in userchats" :key="index">
                    <div style="display: flex; flex-direction: column">
                      <div
                        v-if="chat.user_id != id && user.id == chat.user_id"
                      ...
                      <div
                        v-else-if="user.id == chat.receiver_id"
                        style="align-self: flex-end; max-width: 70%"
                      >
                        <div class="media media-chat">
                          <div class="media-body">
                            <span
                            ...
                            <p
                              class="message"
                              style="color: black; background-color: #48b0f7"
                            >
                              {{ chat.message }}
                            </p>
                            <h6 style="font-size: 10px">
                ...
                <form @submit.prevent="submit">
                  <h5 style="padding: 10px; text-align: center" v-if="messageCount <= 0">
