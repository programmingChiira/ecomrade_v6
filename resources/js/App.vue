          ...
          <div class="col-12">
            <nav
              ...
              <div class="container-fluid px-0">
                <router-link to="/" class="navbar-brand font-weight-bolder ms-sm-3" @click="visible = !visible">
                  Ecomrade
                </router-link>
                ...
                <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" :class="!visible ? 'collapse' : ''"
                  ...
                  <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/" class="font-weight-bolder" :class="{ active: $route.path === '/' }" @click="visible = !visible">
                        Home
                      </router-link>
                    </li>
  
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/market" class="font-weight-bolder" :class="{ active: $route.path === '/market' }" @click="visible = !visible">
                        Market
                      </router-link>
                    </li>
  
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/rental" class="font-weight-bolder" :class="{ active: $route.path === '/rental' }" @click="visible = !visible">
                        Rentals
                      </router-link>
                    </li>
  
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/blog" class="font-weight-bolder" :class="{ active: $route.path === '/blog' }" @click="visible = !visible">
                        Blogs
                      </router-link>
                    </li>
                        ...
                        <div class="d-none d-lg-block">
                          <ul class="list-group">
                            <li class="nav-item list-group-item border-0 p-0">
                              ...
                              <router-link to="/poll" class="dropdown-item py-2 ps-3 border-radius-md" :class="{ active: $route.path === '/poll' }"
                            ...
                            <li class="nav-item list-group-item border-0 p-0">
                              <router-link to="/event" class="dropdown-item py-2 ps-3 border-radius-md" :class="{ active: $route.path === '/event' }"
                                @click="visible = !visible">
                                <div class="d-flex">
                                  <div>
                                    <h6
                            ...
                            <li class="nav-item list-group-item border-0 p-0">
                              <router-link to="/club" class="dropdown-item py-2 ps-3 border-radius-md" :class="{ active: $route.path === '/club' }"
                                @click="visible = !visible">
                                <div class="d-flex">
                                  <div>
                                    <h6
                            ...
                            <li class="nav-item list-group-item border-0 p-0">
                              <router-link to="/resource" class="dropdown-item py-2 ps-3 border-radius-md" :class="{ active: $route.path === '/resource' }"
                                @click="visible = !visible">
                                <div class="d-flex">
                                  <div>
                                    <h6
                    ...
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/faq" class="font-weight-bolder" :class="{ active: $route.path === '/faq' }" @click="visible = !visible">
                        F.A.Q
                      </router-link>
                    </li>
  
                    <li style="margin-top: 5px;margin:5px" class="nav-item">
                      <router-link to="/contact" class="font-weight-bolder" :class="{ active: $route.path === '/contact' }" @click="visible = !visible">
                        Contact
                      </router-link>
                    </li>
                    ...
                    <li v-if="id == false" class="nav-item ms-lg-auto">
                      <router-link to="/login" class="nav-link font-weight-bolder" @click="visible = !visible">
                        ...
                        <p class="d-inline text-sm z-index-1 font-weight-bold"></p>
                      </router-link>
                    </li>
                  </ul>
